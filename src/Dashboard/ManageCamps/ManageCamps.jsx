...
const ManageCamps = () => {
  ...
  return (
    <div className="lg:w-10/12 px-10 mx-auto text-center">
      <Helmet>
        <title>Manage Camp | MediCamp</title>
      </Helmet>
      <div>
        <h1 className="text-4xl text-white pt-20 ">Manage Camps </h1>
        <p className="md:text-lg text-sm mt-2 mb-10 text-white/70">
          {" "}
          Manage your camps by updating details, monitoring registrations, and
          tracking camp status efficiently
        </p>
      </div>
      ...
      <div>
        <Card className="h-full w-full overflow-scroll bg-[#10273D]  text-white ">
          <table className="w-full min-w-max table-auto text-left">
            ...
            <tbody className="">
              {currentManage.map(
                ({ _id, image, name, dateTime, location, professional }) => {
                  return (
                    <tr
                      key={_id}
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                          <Link
                            to={`/dashboard/update-camp/${_id}`}
                            className="bg-[#0495FF] p-2 rounded-md "
                          >
