      ...
      <div>
        {profile.map((prof) => (
          <div className="flex flex-col items-center" key={prof._id}>
            ...
            <div className="md:flex items-center mt-4 gap-6">
            ...
            <div className="hero-content p-8 rounded-lg">
              {profile.map((prof) => (
                <div key={prof._id}>
                  ...
                  >
                    <div className="">
                      <div className="form-control col-span-1 mx-auto ">
                      ...
                      {/* <div className="form-control rounded-full flex justify-center ">
                        <label className="label">
                          <span className="label-text text-white/80 text-lg">
                            Photo
                          </span>
                        </label>
                        <div className="flex items-center bg-[#35485B] rounded-full ">
                          <input
                            type="file"
                            name="image"
