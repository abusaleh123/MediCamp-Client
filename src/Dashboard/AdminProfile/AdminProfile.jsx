...
//     axios.axiosSecure(`/admin-profile/${id}`)
//     console.log(id);
//    }
...
//                     <button onClick={user && (()=>document.getElementById('my_modal_4').showModal()) } className="btn btn-ghost bg-[#0495FF] text-lg mt-8">Update </button>
//                 </div> )
//             }
//          </div>
...
//                                 {
//                                     profile.map(prof => <div key={prof._id} className="">
//                                           <form onSubmit={() => handleUpdate(prof._id)} className="card-body">
//                      <div className=' '>
...
//            <button className="btn btn-ghost text-white px-16 text-lg w-full bg-[#0495FF]">Submit</button>
//          </div>
//          </div>
//        </form>
//                                     </div>)
...
//     const { user } = useAuth();
//     const image_hosting_key = import.meta.env.VITE_IMAGE_HOSTING_KEY;
//     const imageHostingAPI = `https://api.imgbb.com/1/upload?key=${image_hosting_key}`; // Replace with your actual API endpoint
...
//             let imageUrl = profile[0].photo; // Default to existing image URL
...
//                 const imageUploadRes = await axios.post(imageHostingAPI, imageUploadFormData, {
//                     headers: {
//                         'content-type': 'multipart/form-data',
//                     },
//                 });

//                 imageUrl = imageUploadRes.data.display_url; // Update with new image URL
//             }

//             // Set the image URL in the formData to update the profile
//             formData.set('photo', imageUrl);

//             // Send updated data to the backend
//             await axiosSecure.put(`/admin-profile/${id}`, formData, {
//                 headers: {
//                     'Content-Type': 'multipart/form-data',
//                 },
//             });
...
//                             {profile.map((prof) => (
//                                 <div key={prof._id}>
//                                     <form onSubmit={(e) => handleUpdate(e, prof._id)} className="card-body" encType="multipart/form-data">
//                                         <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//                                             <div className="form-control">
//                                                 <label className="label">
//                                                     <span className="label-text text-white/80 text-lg">Name</span>
