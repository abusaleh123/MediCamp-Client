...
const AddCamp = () => {
  ...
  return (
    <div className="w-10/12 mx-auto">
      <Helmet>
        <title>Add Camp | MediCamp</title>
      </Helmet>
      <div className="text-4xl text-center pt-20 pb-10">
        <h1 className=" text-white"> Add Camp</h1>
        <p className="md:text-lg text-sm mt-2 text-white/70">
          Add your camp to showcase its unique features, activities, and
          facilities to potential participants
        </p>
      </div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className=" grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="col-span-2   ">
            <label className="label">
              <span className="label-text text-white/80 b text-lg">
                Camp Image
              </span>
            </label>
