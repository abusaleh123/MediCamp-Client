...
const formSubmit = async (e) => {
  ...
  if (isSubmitSuccessful) {
    ...
    <div class="relative z-10 text-white p-8 flex flex-col justify-center items-center text-center mx-auto">
        ...
        <h1 class="xl:text-7xl lg:text-6xl md:text-4xl text-3xl  font-bold">Welcome to {data.name}</h1>
        <p class="mt-4 text-sm md:text-lg lg:text-xl">Join us for an enriching experience at our medical camps.</p>
        <p className='flex justify-center items-center gap-1 mt-2'><span className='flex justify-center items-center text-lg lg:text-xl text-[#3E8BFF]'><Link to={'/'}>Home </Link></span> <MdKeyboardDoubleArrowRight className='text-2xl' /> <span className="text-lg lg:text-xl">{data.name}</span></p>
    </div>
        ...
        <div className="w-full mx-auto lg:flex gap-10 p-6 items-center rounded-xl ">
  {/* Image Section */}
  ...
  <div className="flex-1 mt-8 lg:mt-0">
    <h1 className="xl:text-7xl lg:text-6xl md:text-4xl text-3xl  font-bold mb-4">{data.name}</h1>
